...
module.exports = function(grunt) {
			...
			.initConfig({
				...
				concat : {
					...
					dist_raw : {
						...
						src : [ 'src/fragments/begin.js-fragment', 'src/*.js',
				...
				jshint : {
					...
					source : [ "./src/*.js" ],
					dist : [ "./dist/betajs-codemirror-noscoped.js",
							"./dist/betajs-codemirror.js" ],
	...
	grunt.registerTask('default', [ 'revision-count', 'concat:dist_raw',
			'concat:dist_css', 'preprocess', 'clean:raw', 'concat:dist_scoped',
			'uglify' ]);
	grunt.registerTask('lint', [ 'jshint:source', 'jshint:dist',
			'jshint:gruntfile' ]);
	grunt.registerTask('check', [ 'lint', 'csslint' ]);
